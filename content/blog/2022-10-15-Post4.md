...
```
Now choose the build to `Build Release`

![liz](../images/programming/sdl2/1/3.jpg)

And finaly run the code by `CTRL+B`.
Now you can see your window

![liz](../images/programming/sdl2/1/4.jpg)

Yaay finally we are running sdl2. Good Job and pat pat on your back.
